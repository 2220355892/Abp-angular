...
{
    public abstract class ProjectABPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProjectABPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProjectABPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProjectABPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProjectABPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProjectABPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProjectABPDbContext, Task<T>> func)
        {
            T result;
